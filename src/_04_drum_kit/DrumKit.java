...
public class DrumKit implements MouseListener {
	...
	public void run() throws MalformedURLException {
		...
		String drum = "drum2.jpg";
		drum2 = createLabelImage(drum);
		panel.add(drum2);
		frame.pack();
		drum2.addMouseListener(this);
		String cymbal = "cymbal.jpg";
		drum3 = createLabelImage(cymbal);
		panel.add(drum3);
		drum3.addMouseListener(this);
		frame.pack();
...
String cymbal = "cymbal.wav";
		...
		if(drumClicked.equals(drumLabelWithImage)) {
			playSound(drumSoundOne);
		}else if(drumClicked.equals(drum3)) {
			playSound(cymbal);
		}
